...
export const PlacemarkSpec = Joi.object()
  .keys({
    ...
    categorie: Joi.string()
      .valid("Landscape feature", "National monumentum", "Walking Trail", "Bridge", "Tree", "Venue", "Ringfort", "Dolmen", "River", "Bog", "Island", "Forest")
      .required(),
    userid: IdSpec,
  })
  .label("PlacemarkSpec");
...
export const changeNameSpec = Joi.object()
  .keys({
...
export const changeNameSpecApi = changeNameSpec
  .keys({
    id: IdSpec.required(),
  })
  .label("ChangeNameSpecApi");

export const changeMailSpec = Joi.object()
  .keys({
...
export const changeMailSpecApi = changeMailSpec
  .keys({
    id: IdSpec.required(),
  })
  .label("ChangeMailSpecApi");

export const changePassSpec = Joi.object()
  .keys({
